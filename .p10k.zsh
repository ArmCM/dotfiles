# Generated by Powerlevel10k configuration wizard on 2020-06-28 at 19:40 CDT.
...
# Add the icon prompt segment UBUNTU

#POWERLEVEL9K_CUSTOM_UBUNTU="echo -n $'\uf17c'"
#POWERLEVEL9K_CUSTOM_UBUNTU_FOREGROUND="white"
...
POWERLEVEL9K_CARRIAGE_RETURN_ICON="\uf071"
  ...
  #STAGED,UNSTAGED,UNTRACKED,CONFLICTED,COMMITS_AHEAD,COMMITS_BEHIND
  ...
  function my_git_formatter() {
    ...
    #acorta el nombre de las ramas y pone ...
    #(( $#where > 35 )) && where[13,-13]="…"
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=136
